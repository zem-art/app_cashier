...
export class AddSalles extends Component {
  constructor() {
    super();
    this.state = {
      data: [],
  ...
  postDate = async () => {
    ...
    axios({
      url: 'https://project-mini.herokuapp.com/api/laporan-penjualan',
      method: 'POST',
      headers: {
            ...
            return (
              <View style={styles.inbody1}>
                <View style={styles.pactName}>
                  <Text style={styles.text}>Nama Kasir</Text>
                  <Text>{i.kasir} </Text>
                </View>
                <View style={styles.pactName}>
                  <Text style={styles.text}>Kode Member</Text>
                  <Text>{i.kode_member} </Text>
                </View>
                <View style={styles.data}>
                  <View style={styles.inData}>
                    <Text style={styles.textStock}>Kembalian</Text>
                    <Text>Rp . {i.kembalian}</Text>
                  </View>
                  <View style={styles.inData}>
                    <Text style={styles.textStock}>Cash</Text>
                    <Text>Rp . {i.dibayar}</Text>
                  </View>
                  <View style={styles.inData}>
...
export default connect(mapStateToProps)(AddSalles);
